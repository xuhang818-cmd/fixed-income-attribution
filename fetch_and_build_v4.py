"""
Fixed Income Portfolio Attribution Dashboard — v4
==================================================
Key Rate Duration (KRD) implementation:
  LQD (dur=8.4y): DGS5 + DGS30  (linear interpolation between 5y and 30y nodes)
  HYG (dur=4.1y): DGS2 + DGS5   (linear interpolation between 2y and 5y nodes)

Rate contribution = −KRD_near × Δr_near − KRD_far × Δr_far
...
<p class="sub">LQD (IG) &nbsp;·&nbsp; HYG (HY) &nbsp;·&nbsp; __START_DATE__ – __END_DATE__ &nbsp;·&nbsp; Campisi + Key Rate Duration</p>
...
const LY={paper_bgcolor:'transparent',plot_bgcolor:'transparent',
...
def main():
    ...
    if have_oas and have_rates:
        ...
        if yf_yields is not None:
            ...
            if r2_use  is None and r5_use  is not None: r2_use  = r5_use  # rough proxy
